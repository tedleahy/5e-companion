...
- Category screens use a shared header; **Back to Compendium** returns through protected history when available, with a hub replacement fallback for direct entry.
