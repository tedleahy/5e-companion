...
- The responsive hub displays all eight category cards. Classes, Subclasses, and Spells are enabled; the remaining five are visibly marked as coming soon until their count summaries and links are enabled in the next implementation step. Their browse routes already exist for direct development access.
