...
export type CustomSubclassManagerFieldsFragment = { __typename?: 'CustomSubclass', id: string, value: string, classId: string, className: string, name: string, description: Array<string>, features: Array<{ __typename?: 'AvailableSubclassFeature', id: string, name: string, description: string, level: number }> };
...
export type CreateCustomSubclassMutation = { __typename?: 'Mutation', createCustomSubclass: { __typename?: 'CustomSubclass', id: string, value: string, classId: string, className: string, name: string, description: Array<string>, features: Array<{ __typename?: 'AvailableSubclassFeature', id: string, name: string, description: string, level: number }> } };
...
export type UpdateCustomSubclassMutation = { __typename?: 'Mutation', updateCustomSubclass: { __typename?: 'CustomSubclass', id: string, value: string, classId: string, className: string, name: string, description: Array<string>, features: Array<{ __typename?: 'AvailableSubclassFeature', id: string, name: string, description: string, level: number }> } };
